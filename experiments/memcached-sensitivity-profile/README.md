...
Swan provides package [validate](https://github.com/intelsdi-x/swan/blob/master/pkg/experiment/sensitivity/validate/validate.go) has method `OS()` which performs checks against mentioned issues.
