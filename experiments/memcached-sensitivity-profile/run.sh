...
OPTS="--mutilate_agent=10.4.3.3 --mutilate_agent=10.4.3.4 --mutilate_agent=10.4.3.5 --mutilate_agent=10.4.3.6 --mutilate_agent=10.4.3.7 --mutilate_agent=10.4.3.8  --log debug"

echo --- go ---
export GOPATH=/home/ppalucki/gopath
go run /home/ppalucki/gopath/src/github.com/intelsdi-x/swan/experiments/memcached-sensitivity-profile/*.go $OPTS
