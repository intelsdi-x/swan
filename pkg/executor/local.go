...
func (taskHandle *localTaskHandle) GetStatus() TaskState {
	if !taskHandle.isTerminated() {
		return RUNNING
	}
...
func (taskHandle *localTaskHandle) GetExitCode() (int, error) {
	if !taskHandle.isTerminated() {
...
func (taskHandle *localTaskHandle) Stdout() (io.Reader, error) {
...
func (taskHandle *localTaskHandle) Stderr() (io.Reader, error) {
