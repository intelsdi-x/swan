...
```sh
$ git clone git@github.com:intelsdi-x/athena.git
$ cd athena/vagrant/
...
1. `vagrant reload`
1. `cd $GOPATH/github.com/intelsdi-x/athena/vagrant`
1. `vagrant up`

## Running the integration tests

1. SSH into the VM: `vagrant ssh`
1. Change to the athena directory: `cd ~/athena`
1. Fetch athena dependencies: `make deps`
