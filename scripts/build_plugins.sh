...
# Disabled temporarly, see SCE-895
#installPlugin snap-plugin-publisher-cassandra 188b78e3e6b29dc3b80d8a9e9dd21eb5a5a8a81a build/rootfs/snap-plugin-publisher-cassandra
...
# Temporary fix, see SCE-895
pushd $GOPATH/src/github.com/intelsdi-x/snap-plugin-publisher-cassandra
go get -d github.com/intelsdi-x/snap-plugin-publisher-cassandra
git reset --hard
git checkout 188b78e3e6b29dc3b80d8a9e9dd21eb5a5a8a81a
patch -p1 < $GOPATH/src/github.com/intelsdi-x/swan/misc/snap-plugin-publisher-cassandra.patch
popd
